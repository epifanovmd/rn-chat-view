...
public extension ContextMenuTheme {
    ...
    static let light = ContextMenuTheme(
        ...
        menuShadowRadius:            16,
        menuSeparatorColor:          UIColor(white: 0.85, alpha: 1),
        actionTitleFont:             .systemFont(ofSize: 15),
        actionTitleColor:            .black,
        actionDestructiveTitleColor: .systemRed,
        actionIconColor:             UIColor(white: 0.2, alpha: 1),
        actionDestructiveIconColor:  .systemRed,
        actionItemHeight:            38,
        actionHorizontalPadding:     14,
        actionHighlightColor:        UIColor(white: 0.93, alpha: 1),
        openDuration:                0.40,
        closeDuration:               0.26,
        springDamping:               0.82,
        springVelocity:              0.5,
